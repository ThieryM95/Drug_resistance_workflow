...
# BASH MAKE XML FILES                                                                       #
#                                                                                           #
# Input: txt file with seed for each scenario, and base xml file                            #
#                                                                                           #
# Task: Creates OpenMalaria-ready xml input files using a base xml file and a txt file      #
#       that associates variable names and variable values. Uses sed pattern replacement.   #
#                                                                                           #
# Output: Xml file for each scenario                                                        #
#                                                                                           #
# Arguments:                                                                                #
